 ...
 */
package com.github.fj.lib.i18n
 ...
 */
private val COUNTRY_DATA: Map<String, List<String>> = Collections.unmodifiableMap(
 ...
 */
fun Locale.toRegional(): Locale {
    val data = COUNTRY_DATA[country] ?: return this
    val subRegion = data[2]
    if (subRegion.isEmpty()) {
        return this
    }

    return Locale(language, subRegion)
}
 ...
 * will do nothing otherwise.
 */
fun Locale.toSubRegional(): Locale {
    val data = COUNTRY_DATA[country] ?: return this
    val subRegion = data[4]
    if (subRegion.isEmpty()) {
        return this
    }
